...
contract('Token',([deployer,sender,receiver, exchange])=>{
	...
	describe('sending tokens', ()=> {
		...
		describe('failure',async()=>{
			...
			it('attempt transfer token when you have none', async()=>{
				let invalidAmount
			...
			it('rejects invalid recipients', async()=>{
				let invalidAmount
				invalidAmount = tokens(10)
				await token.transfer(0x0,invalidAmount,{from:receiver}).should.be.rejected
...
describe('Delegated Token Transfer via Exchange', ()=> {
		let amount
		let result
